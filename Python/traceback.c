...
_PyTraceBack_FromFrame(PyObject *tb_next, PyFrameObject *frame)
{
    ...
    return tb_create_raw((PyTracebackObject *)tb_next, frame, _PyFrame_GetInstructionIndex(frame),
...
dump_frame(int fd, PyFrameObject *frame)
{
    ...
    lineno = PyCode_Addr2Line(code, _PyFrame_GetInstructionIndex(frame));
    PUTS(fd, ", line ");
    if (lineno >= 0) {
