...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=26, argval=146, argrepr='to 146', offset=118, starts_line=None, is_jump_target=False),
  ...
  Instruction(opname='JUMP_IF_NOT_EXC_MATCH', opcode=121, arg=144, argval=144, argrepr='', offset=124, starts_line=None, is_jump_target=False),
