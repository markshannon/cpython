...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_MULTIPLY_UNBOXED_FLOAT] = 0,
    [_ADD_UNBOXED_FLOAT] = 0,
    [_BOX_FLOAT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_UNBOX_FLOAT] = 0,
    [_LOAD_UNBOXED_FLOAT] = 0,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    [_ADD_UNBOXED_FLOAT] = "_ADD_UNBOXED_FLOAT",
    ...
    [_LOAD_UNBOXED_FLOAT] = "_LOAD_UNBOXED_FLOAT",
    ...
    [_MULTIPLY_UNBOXED_FLOAT] = "_MULTIPLY_UNBOXED_FLOAT",
    [_NOP] = "_NOP",
